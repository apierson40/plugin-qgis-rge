...
SOURCES = \
	__init__.py \
	extract_rge.py extract_rge_dialog.py

PLUGINNAME = plugin_qgis_rge

PY_FILES = \
	__init__.py \
	extract_rge.py extract_rge_dialog.py

UI_FILES = extract_rge_dialog_base.ui
...
QGISDIR=/home/apierson/.local/share/QGIS/QGIS3/profiles/default/python/plugins/
